...
namespace FinMaSys
{
    public partial class UserEdit : Form
    {
        ...
        private void UserEdit_Load(object sender, EventArgs e)
        {
            ...
            switch (this.Text)
            {
                ...
                case "客商修改":
                    ...
                    cbUserGroup.Items.Add(CommonClass.Select_RePersonType);
                    cbUserGroup.SelectedIndex = 0;
                    tbOpenBank.Text= CommonClass.Select_OpenBank;
                    tbAccNum.Text= CommonClass.Select_tbAccNum;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string strUserNormal=commonClass.IniReadValue("UserStatus", "Normal",Application.StartupPath+@"\FinMaSys.ini").ToString().Trim();
            switch (this.Text)
            {
                default:
                    break;
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        dataBase.Cmd = "INSERT INTO  tb_Users  (userGroupID,userID,StatusID,userName,passWord) select top 1 userGroupID ,'" + txtUserID.Text.Trim() + "',"+ strUserNormal + ",'" + txtUserName.Text.Trim() + "','888' from tb_Usergroup where userGroupName ='" + cbUserGroup.Text.Trim() + "'";
                ...
                case "客商修改":
                    try
                    {
                        ...
                        {
                            DataBase dataBase = new DataBase();
                            dataBase.Cmd = "UPDATE tb_Contr_RePerson SET rePersonName='" + txtUserName.Text.Trim() + "', [rePersonType] ='" + cbUserGroup.Text.Trim() + "',rePersonOpenBank='"+tbOpenBank.Text.Trim()+"',rePersonAccNum='"+tbAccNum.Text.Trim()+"'   WHERE repersid='" + txtUserID.Text.Trim() + "'";
                            dataBase.DataExcute("Update");
                            MessageBox.Show("已修改成功!", "修改提示");
                            this.Close();
                        }
