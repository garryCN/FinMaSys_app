...
namespace FinMaSys
{
    public partial class Departments : Form
    {
        ...
        private void dgvDept_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {

        }

        private void dgvDept_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
